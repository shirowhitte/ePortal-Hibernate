...
<h3 class="pt-5"><center>View Order History</center></h3>
              ...
              <table class="display" id="myTable">
                <thead>
                  <tr>
                    ...
                    <th class="bg-dark text-white" scope="col">Status</th>
                    <th class="bg-dark text-white" scope="col">View</th>
                  </tr>
                </thead>
                ...
                <c:forEach var="order" items="${orderList}"> 
                  <tr>  
                  	<td><img src="/ePortal-Hibernate/resources/img/login/${order.ostatus}Dot.png" width="30px" height="30px"/></td>
                    <td>${order.oid}</td>
                    ...
                    <td>${order.ostatus}</td>
                    <td><a href="vendorViewOrderDetail/${order.oid}">more</a></td>
                  </tr>
                  </c:forEach> 
