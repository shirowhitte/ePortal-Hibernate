...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
 <a href="vendorHome" class="pl-1"><img src="/ePortal-Hibernate/resources/img/blue-logo.png" class="brand-logo" alt="logo"></a>
  ...
  <div class="nav-items-1 pr-2"><a href="/ePortal-Hibernate/vendorLogin"><b>Logout</b></a></div>
</nav>
<br>
