...
<h3 class="pt-5"><center>Update Product</center></h3>
              ...
              <table class="display" id="myTable">
                ...
                <c:forEach var="product" items="${plist}"> 
                  <tr>  
                    ...
                    <td>${product.price }</td>
                    <td><a href="updateThisProduct/${product.pid}"><i class="fa fa-pencil-square-o text-primarty" aria-hidden="true"></i></a></td>
                  </tr>
                  </c:forEach> 
                </tbody>
              </table>
