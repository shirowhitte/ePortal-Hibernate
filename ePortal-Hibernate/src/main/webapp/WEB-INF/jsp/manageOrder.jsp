...
<div class="container" style="margin-bottom:100px;">
	<h3><center>Manage Order</center></h3>
        <div class="row my-2 mt-5">
            ...
            <div class="col-md-4">
	            <a href="viewOrder">
	                <img src="/ePortal-Hibernate/resources/img/vieworder.png" width="300px" height="200px" class="img-fluid z-depth-3 rounded" alt="Manage Product">
	            </a>
            </div>
            <!--Grid column-->
             <!--Grid column-->
            <div class=" col-md-4">
            	<a href="updateOrderStatus">
                	<img src="/ePortal-Hibernate/resources/img/updateorderstatus.png" width="300px" height="200px"class="img-fluid z-depth-3 rounded" alt="Manage Order">
            	</a>
            </div>
            <div class="col-md-4">
            	<a href="orderHistory">
                	<img src="/ePortal-Hibernate/resources/img/orderhistory.png" width="300px" height="200px"class="img-fluid z-depth-3 rounded" alt="Generate Report">
            	</a>
            </div>
            <!--Grid column-->
        </div>
