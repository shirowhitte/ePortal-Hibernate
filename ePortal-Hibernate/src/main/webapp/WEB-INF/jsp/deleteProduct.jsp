...
<h3 class="pt-5"><center>Delete Product</center></h3>
              ...
              <table class="display" id="myTable">
                ...
                <tbody>
                  ...
                  <tr>  
                    ...
                    <td>${product.price}</td>
                    <td><a href="/ePortal-Hibernate/deleteProduct/${product.pid}" onclick="return confirm('Are you sure?')"><button class="btn btn-link"><i class="fa fa-trash text-danger" aria-hidden="true"></i></button></a></td>
                  </tr>
                  </c:forEach> 
                </tbody>
              </table>
