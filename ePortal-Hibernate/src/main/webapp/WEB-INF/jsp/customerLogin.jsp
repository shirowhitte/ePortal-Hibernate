...
<nav class="navbar">
<div class="nav">
	<a href="./index.jsp"><img src="/ePortal-Hibernate/resources/img/dark-logo.png" class="brand-logo" alt="logo"></a>
    <div class="nav-items"> 
        <a href="customerRegister"><b>Register &nbsp;&nbsp;&nbsp;&nbsp;|</b></a>
...
<div class="container">
	<h1><center>User Login</center></h1><br>
		<form:form action="loginForm" modelAttribute="customer">    
	       <table>    
	         <tr class="spaceUnder">      
	          	<td><form:input path="username" placeholder="Username" /></td>
	         </tr> 
	         <tr class="spaceUnder">    
	          	<td><form:password path="password" placeholder="Password"  /> <form:errors path="password" cssClass="error"/><br><br> </td>  
	         </tr>
	         <tr>
	         ...
	         <tr>
	         <td><span style="color: orange;" id="msg"><center><b>${msg}</b></center></span></td>
	         </tr>  
	       </table>    
       	</form:form> 
	    <br>
       <p><center>Does not own an account? Register <a style="text-decoration:none;color:orange;" href="customerRegister">here.</a></center></p>  
</div>
